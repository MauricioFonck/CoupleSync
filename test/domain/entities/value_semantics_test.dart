...
void main() {
  ...
  test('Activity igualdad/hashCode/copyWith/toString', () {
    ...
    expect(
      a().copyWith(description: 'x', category: ActivityCategory('C2')).category,
      ActivityCategory('C2'),
    );
  ...
  test('Confirmation igualdad/hashCode/copyWith/toString', () {
    ...
    expect(
      c1.copyWith(status: ConfirmationStatus.approved).status,
  ...
  test('ScheduledEvent igualdad/hashCode/copyWith/toString', () {
    ...
    expect(
      e().copyWith(activityIds: [ActivityId('a2')]).activityIds.single,
      ActivityId('a2'),
    );
